...
- Frame every question as: "Investors ask this because..." not just the question itself — each question in the array should be preceded by the investor psychology behind it.
- The hardest questions should reveal what most founders avoid confronting.
- difficulty_reason (when applicable) must explain the REAL investor psychology: what are they actually testing for?
- model_answer (when applicable) must show the reasoning process, not just the answer.
- trap (when applicable) must explain what most founders say and why it fails.
