...
EMAIL PSYCHOLOGY:
Each email must follow the psychology of emails that actually get replies:
1. Show you know exactly who they are (not generic flattery)
2. Say what you do in one sentence that a 12-year-old could understand
3. Make the ask tiny — not "can we schedule a 30-min call" but "worth a 15-min chat?"
4. Never say: "I hope this finds you well", "I wanted to reach out", "touching base", "synergy"
5. The best cold emails feel like they were written in 5 minutes by someone confident
6. Never oversell. Undersell with precision.

For the subject line:
- Never use ALL CAPS or excessive punctuation
- Best subject lines are 4-7 words and sound like a human wrote them
...
- Never use ALL CAPS or excessive punctuation
- Best subject lines are 4-7 words and sound like a human wrote them
- Examples: "Quick question about [their company]" or "Your [specific thing] + what we're building"
