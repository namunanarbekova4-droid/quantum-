  ...
  return (
    <div className="min-h-screen bg-[#06040F] flex items-center justify-center p-8">
      ...
      >
        ...
        <h1 className="text-3xl font-bold text-white mb-3">Find First Customer</h1>
        <p className="text-[#8B7CF8] mb-8 leading-relaxed">
          Describe your product and we find real people who need it right now — with contact info and talking points.
        </p>
