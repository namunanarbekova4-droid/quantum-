...
const T = {
  en: {
    ...
    challenge_desc: "Big decision ahead? Let Quantum pressure-test it before you commit. Find the flaws before anyone else does.",
  ...
  ru: {
    ...
    tagline: "Что требует вашего внимания сегодня?",
