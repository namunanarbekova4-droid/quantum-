...
const T = {
  en: {
    ...
    tagline: "Built for founders before the world catches on. What are we shipping today?",
    search_placeholder: "Find your weapon...",
    ...
    hero1_desc: "Say your pitch out loud. Get brutally honest coaching in real time. Walk into your next investor meeting knowing exactly what lands — and what doesn't.",
    hero1_s1: "Real-time feedback", hero1_s2: "Voice analysis",
    hero1_btn: "Start Session →",
    hero1_badge: "LIVE",
    hero2_title: "Pitch Deck Creator",
    hero2_desc: "Answer 10 questions in your own words. Get a complete professional pitch deck written in your exact voice — cinematic, investor-ready, and distinctly yours.",
    ...
    hero3_desc: "Record yourself pitching. Watch it back with AI annotations. See exactly how investors see you — and fix the gaps before they cost you the deal.",
    ...
    challenge_desc: "Before you commit to a big call, let Quantum argue the other side. Find the holes in your thinking before an investor finds them for you.",
    challenge_btn: "Put It to the Test →",
  },
  ru: {
