...
import {
  ...
  Lock, Settings, ChevronRight, Star, Users, MessageSquare, GraduationCap,
  Newspaper, Beaker, CalendarClock, PlusCircle, Wrench
} from "lucide-react";
  ...
  const groups = [
    {
      ...
      items: [
        ...
        { label: t.nav.newDecisionNav, href: "/dashboard/new", icon: PlusCircle },
    ...
    },
    {
      ...
      items: [
        { label: t.nav.strategicTools, href: "/dashboard/tools", icon: Wrench },
    ...
    <div className={cn(
      ...
      <nav className="flex-1 p-3 space-y-4 overflow-y-auto">
        {groups.map((group) => (
          <div key={group.label}>
            {!collapsed && (
              <p className="px-3 mb-1 text-[10px] font-semibold uppercase tracking-widest text-[#444]">
                {group.label}
              </p>
            )}
